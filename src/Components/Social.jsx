...
const Social = () => {
  return (
    <>
      <section className="relative bg-gray-100 h-48 mb-1">
        <div className="flex  flex-col max-sm:px-4 justify-center  items-center w-full h-auto border border-gray-100 ">
          ...
          <div className="flex justify-around px-10 items-center w-96 rounded-full h-36 max-sm:h-28 bg-gray-200  border border-gray-200 max-sm:w-64">
            <Twitter className="text-2xl text-sky-600" /> <Facebook className="text-2xl text-blue-950" />{" "}
            <Whatsapp className="text-2xl text-green-600" /> <Telegram className="text-2xl text-blue-900" />
          </div> 
        </div>
      </section>
    </>
